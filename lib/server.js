...
var SolidusServer = function( options ){
	...
	swag.registerHelpers( handlebars ); // add in extra handlebars helpers
	var hbs_config = {
		extname: '.hbs',
	...
	var hbs = this.hbs = express_handlebars.create( hbs_config );
	router.engine( DEFAULT_VIEW_EXTENSION, hbs.engine );
